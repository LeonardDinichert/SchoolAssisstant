...
struct MeditationPreWorkView: View {
    ...
    private func configureAudioSession() {
        ...
        try? session.setCategory(.playback, mode: .default, options: [])  //  [oai_citation:8‡Apple Developer](https://developer.apple.com/documentation/avfaudio/avaudiosession?utm_source=chatgpt.com)
